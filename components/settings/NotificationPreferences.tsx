...
export function NotificationPreferences() {
  ...
  if (loading) {
    return (
      <div className="max-w-4xl animate-pulse space-y-6">
        <div className="h-8 bg-gray-200 dark:bg-stone-700 rounded w-1/3"></div>
        <div className="h-48 bg-gray-200 dark:bg-stone-700 rounded"></div>
        <div className="h-32 bg-gray-200 dark:bg-stone-700 rounded"></div>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-4xl space-y-8">
      ...
      {/* SMS Alerts Section */}
      <div className="bg-gray-100 dark:bg-stone-800 rounded-2xl p-6 space-y-4">
        <h3 className="text-lg font-medium text-gray-900 dark:text-stone-100 flex items-center gap-2">
      ...
      <div className="bg-gray-100 dark:bg-stone-800 rounded-2xl p-6">
        <h3 className="text-lg font-medium text-gray-900 dark:text-stone-100 flex items-center gap-2 mb-4">
        ...
        <div className="relative max-w-xs">
          <input
            ...
            className="w-full pl-4 pr-16 py-2.5 rounded-xl border border-gray-300 dark:border-stone-600 bg-white dark:bg-stone-700 text-gray-900 dark:text-stone-100 focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition-colors"
          />
          <span className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-700 dark:text-stone-300 font-medium">
            GNF
          </span>
        </div>
      </div>
      ...
      <div className="bg-gray-100 dark:bg-stone-800 rounded-2xl p-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1">
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-stone-600 bg-white dark:bg-stone-700 text-gray-900 dark:text-stone-100 focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition-colors"
            />
          </div>
          <div className="flex-1">
            <label className="block text-sm font-medium text-gray-700 dark:text-stone-200 mb-1">
        ...
        {(preferences.quietHoursStart || preferences.quietHoursEnd) && (
          <button
            ...
            className="mt-3 text-sm text-gray-600 dark:text-stone-400 hover:text-gray-800 dark:hover:text-stone-200 transition-colors"
          >
      ...
      <div className="bg-gray-100 dark:bg-stone-800 rounded-2xl p-6">
        ...
        <div className="flex gap-4">
          <label className="flex items-center gap-3 p-3 rounded-xl bg-white dark:bg-stone-700 cursor-pointer hover:bg-gray-200 dark:hover:bg-stone-600 transition-colors">
            <input
              type="radio"
              name="locale"
              value="fr"
            ...
            />
            <span className="text-gray-900 dark:text-stone-100 font-medium">Français</span>
          </label>
          <label className="flex items-center gap-3 p-3 rounded-xl bg-white dark:bg-stone-700 cursor-pointer hover:bg-gray-200 dark:hover:bg-stone-600 transition-colors">
            <input
              type="radio"
              ...
              className="w-4 h-4 text-gray-700 focus:ring-gray-500"
            />
            <span className="text-gray-900 dark:text-stone-100 font-medium">English</span>
          </label>
        </div>
      </div>
      ...
      <div className="flex justify-end">
        <button
          onClick={handleSave}
          disabled={saving}
          className="inline-flex items-center gap-2 px-6 py-2.5 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-xl hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {saving ? (
            <>
    ...
    <div className="flex items-start gap-4 p-4 rounded-xl bg-white dark:bg-stone-700">
      ...
      <div className="flex-1">
        <div className="flex items-center justify-between">
          <div>
            <label className="font-medium text-gray-900 dark:text-stone-100">
              {label}
            </label>
