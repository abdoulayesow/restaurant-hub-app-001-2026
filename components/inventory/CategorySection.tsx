...
export function CategorySection({
  ...
  return (
    <div className="mb-6">
      ...
      <button
        onClick={onToggle}
        className="flex items-center justify-between w-full p-4 bg-gray-50 dark:bg-stone-800 hover:bg-gray-100 dark:hover:bg-stone-700 rounded-xl mb-4 transition-colors border border-gray-200 dark:border-stone-700 shadow-sm"
      >
        <div className="flex items-center gap-3">
          <ChevronRight
            className={`w-5 h-5 text-gray-500 dark:text-stone-400 transition-transform duration-200 ${
          ...
          <span className="px-2.5 py-1 text-xs font-medium rounded-lg bg-gray-200 dark:bg-stone-700 text-gray-700 dark:text-stone-300">
        ...
        {lowStockCount > 0 && (
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-amber-100 dark:bg-amber-900/30 text-amber-800 dark:text-amber-400">
